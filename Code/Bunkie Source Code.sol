...
Telegram: https://t.me/bunkiechan
Discord: https://discord.gg/g9nJtE3qae
  
Description:

	Bunkie-chan is a clean fork of the SafeMoon contract with minimal changes.

	How does the BUNKIE token smart contract transfer function work?

		BUNKIE is a BEP-20 token on the Binance Smart Chain. It works like all other BEP-20 tokens, but also includes some additional features in its transfer function. These features are Reflection and Liquidity Pool (LP) Acquisition.

			Reflection: Holders earn passive rewards through static reflection as their balance of BUNKIE grows.
	...
	Incentives -
		...
		LP acquisition: Selling results in a 10% transfer fee that helps support the price of the token.

	Because of these features, it is recommended that traders set their slippage tolerance to 12%+.
